...
export function AddJobModal({ isOpen, onClose, onJobAdded, initialValues }: AddJobModalProps) {
  ...
  return (
    <DialogShell
      ...
      wrapperClassName="fixed inset-0 z-50 flex items-end justify-center p-0 sm:items-center sm:p-4"
      panelClassName="bg-white w-full max-w-lg max-h-[92dvh] sm:max-h-[min(760px,calc(100dvh-2rem))] rounded-t-[2rem] sm:rounded-3xl shadow-2xl flex flex-col overflow-hidden"
    >
        ...
        <form onSubmit={handleSubmit} className="min-h-0 flex flex-1 flex-col">
          <div className="min-h-0 flex-1 overflow-y-auto p-5 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="max-h-40 overflow-y-auto rounded-2xl border border-slate-200 bg-slate-50/60 p-2 space-y-2">
          ...
          <div className="shrink-0 border-t border-slate-100 bg-white p-4 sm:p-5 flex gap-3">
            <button
              type="button"
              onClick={onClose}
