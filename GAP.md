...
| 5 | Generate per-user API keys (hashed in DB, lookup user on request) | GAP-008 | In Progress | Next active task |
| 6 | Rate limit auth endpoints (5 req/min per IP) | GAP-009 | Not Started | Revisit after per-user API keys land |
